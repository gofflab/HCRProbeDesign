...
initiators = {
    "B1": {"odd": "gAggAgggCAgCAAACggAA", "even": "TAgAAgAgTCTTCCTTTACg"},
    "B2": {"odd": "CCTCgTAAATCCTCATCAAA", "even": "AAATCATCCAgTAAACCgCC"},
    "B3": {"odd": "gTCCCTgCCTCTATATCTTT", "even": "TTCCACTCAACTTTAACCCg"},
    "B4": {"odd": "CCTCAACCTACCTCCAACAA", "even": "ATTCTCACCATATTCgCTTC"},
    "B5": {"odd": "CTCACTCCCAATCTCTATAA", "even": "AACTACCCTACAAATCCAAT"},
}
